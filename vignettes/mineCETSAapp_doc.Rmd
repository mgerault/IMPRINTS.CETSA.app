...
Second step is now to normalize the peptides data the same way it is done for protein using the 'ms_2D_normalization' function from mineCETSA package.
...
You can use the 'imprints_barplotting_sh' function to plot your final results.
